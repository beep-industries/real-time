...
#
#     PHX_SERVER=true bin/beep_real_time start
#
...
if config_env() == :prod do
  ...
  config :beep_real_time, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :beep_real_time, BeepRealTime.Mailer,
